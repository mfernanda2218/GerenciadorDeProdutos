            ...
            <table className="table table-compact sm:table-lg w-full">
              <thead>
                <tr className="bg-base-200">
                  ...
                  <th className="font-bold text-right hidden md:table-cell">Preço Custo</th>
              ...
              <tbody>
                {products.map((p: any) => (
                  <tr key={p.id} className="hover:bg-base-100 transition-colors border-b border-base-200 last:border-0">
                    <td className="font-bold text-base md:text-lg">{p.name}</td>
                    ...
                    <td className="text-center">
                      <div className={`badge badge-md md:badge-lg font-bold ${p.quantity === 0 ? 'badge-error' : p.quantity <= 10 ? 'badge-warning' : 'badge-success'}`}>
                        {p.quantity} un
                      </div>
                    </td>
                    <td className="text-center">
